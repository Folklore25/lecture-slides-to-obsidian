...
This skill is a thin composition layer. The official `mineru-open-api` CLI owns extraction/network behavior; `obsidian-markdown` and `json-canvas` own output syntax. This skill owns routing, profile normalization, vault boundaries, and temporary QA.
